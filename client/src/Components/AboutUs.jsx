        ...
        <div className="about-us-container" style={{ padding: '50px', textAlign: 'center' }}>
            ...
            <Card
                ...
                header={
                    <img
                        alt="Survey"
                        src="../image.png" // ניתן להחליף בלוגו או תמונה רלוונטית
                        style={{
                            maxWidth: '40%',
            ...
            >
                ...
                <p style={{ fontSize: '16px', lineHeight: '1.8', color: '#555' }}>
                    Welcome to <strong>SurveyLand</strong>, the ultimate Israeli platform for creating, sharing, and exploring surveys! 
                ...
                <p style={{ fontSize: '16px', lineHeight: '1.8', marginTop: '20px', color: '#555' }}>
                    ...
                    SurveyLand makes it easy, fun, and rewarding to participate in the conversation that shapes our society.
                </p>
